...
int shouldStop(Elevator *p_elevator) {
  ...
  if (p_elevator->orderArray[p_elevator->currentFloor][0] == 1) {
    return 1;
  } else if (p_elevator->orderArray[p_elevator->currentFloor + 4][0] == 1 &&
             p_elevator->currentDirection == DIRN_DOWN) {
    return 1;
  } else if (p_elevator->orderArray[p_elevator->currentFloor + 4][1] == 1 &&
             p_elevator->currentDirection == DIRN_UP) {
    return 1;
  }
  return 0;
}
